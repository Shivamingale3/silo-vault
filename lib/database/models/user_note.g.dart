...
const UserNoteSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'noteType': PropertySchema(
      ...
      name: r'noteType',
      type: IsarType.byte,
      enumMap: _UserNotenoteTypeEnumValueMap,
    ),
...
void _userNoteSerialize(
  ...
  writer.writeByte(offsets[2], object.noteType.index);
...
UserNote _userNoteDeserialize(
  ...
  object.noteId = id;
  object.noteType =
      _UserNotenoteTypeValueEnumMap[reader.readByteOrNull(offsets[2])] ??
      NoteType.note;
...
P _userNoteDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_UserNotenoteTypeValueEnumMap[reader.readByteOrNull(offset)] ??
              NoteType.note)
          as P;
    case 3:
      return (reader.readString(offset)) as P;
...
const _UserNotenoteTypeEnumValueMap = {'note': 0, 'password': 1};
const _UserNotenoteTypeValueEnumMap = {0: NoteType.note, 1: NoteType.password};
...
extension UserNoteQueryWhereSort on QueryBuilder<UserNote, UserNote, QWhere> {
  QueryBuilder<UserNote, UserNote, QAfterWhere> anyNoteId() {
...
extension UserNoteQueryWhere on QueryBuilder<UserNote, UserNote, QWhereClause> {
  QueryBuilder<UserNote, UserNote, QAfterWhereClause> noteIdEqualTo(Id noteId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.between(lower: noteId, upper: noteId),
      );
    });
  }
  ...
  QueryBuilder<UserNote, UserNote, QAfterWhereClause> noteIdGreaterThan(
    Id noteId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserNote, UserNote, QAfterWhereClause> noteIdLessThan(
    Id noteId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserNote, UserNote, QAfterWhereClause> noteIdBetween(
    Id lowerNoteId,
    Id upperNoteId, {
...
extension UserNoteQueryFilter
  ...
  QueryBuilder<UserNote, UserNote, QAfterFilterCondition> createdAtEqualTo(
    DateTime value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<UserNote, UserNote, QAfterFilterCondition> createdAtGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserNote, UserNote, QAfterFilterCondition> createdAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserNote, UserNote, QAfterFilterCondition> createdAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserNote, UserNote, QAfterFilterCondition> noteIdEqualTo(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'noteId', value: value),
      );
    });
  }
  ...
  QueryBuilder<UserNote, UserNote, QAfterFilterCondition> noteTypeEqualTo(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'noteType', value: value),
      );
    });
  }
  ...
  QueryBuilder<UserNote, UserNote, QAfterFilterCondition> updatedAtEqualTo(
    DateTime value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<UserNote, UserNote, QAfterFilterCondition> updatedAtGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserNote, UserNote, QAfterFilterCondition> updatedAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserNote, UserNote, QAfterFilterCondition> updatedAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserNoteQuerySortBy on QueryBuilder<UserNote, UserNote, QSortBy> {
  ...
  QueryBuilder<UserNote, UserNote, QAfterSortBy> sortByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<UserNote, UserNote, QAfterSortBy> sortByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserNote, UserNote, QAfterSortBy> sortByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.asc);
    });
  }

  QueryBuilder<UserNote, UserNote, QAfterSortBy> sortByUpdatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserNoteQuerySortThenBy
  ...
  QueryBuilder<UserNote, UserNote, QAfterSortBy> thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<UserNote, UserNote, QAfterSortBy> thenByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.desc);
    });
  }
  ...
  QueryBuilder<UserNote, UserNote, QAfterSortBy> thenByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.asc);
    });
  }

  QueryBuilder<UserNote, UserNote, QAfterSortBy> thenByUpdatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.desc);
    });
  }
...
extension UserNoteQueryWhereDistinct
  ...
  QueryBuilder<UserNote, UserNote, QDistinct> distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserNote, UserNote, QDistinct> distinctByNoteType() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'noteType');
    });
  }
  ...
  QueryBuilder<UserNote, UserNote, QDistinct> distinctByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension UserNoteQueryProperty
  ...
  QueryBuilder<UserNote, int, QQueryOperations> noteIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserNote, DateTime, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createdAt');
    });
  }

  QueryBuilder<UserNote, NoteType, QQueryOperations> noteTypeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserNote, DateTime, QQueryOperations> updatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
